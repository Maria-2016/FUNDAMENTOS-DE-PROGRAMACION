...
def mostrar_promedios(ciudad_index):
    promedio_semanal, promedio_ciudad = promedios_por_ciudad[ciudad_index]
    print(f"\nCiudad {ciudad_index + 1}:")
...
while True:
    print("\nOpciones:")
    print("1. Ver promedios de Ciudad 1")
    print("2. Ver promedios de Ciudad 2")
    print("3. Ver promedios de Ciudad 3")
    print("4. Salir")
